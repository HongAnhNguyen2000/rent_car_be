import { alpha, Theme, useTheme, experimentalStyled as styled } from '@mui/material/styles';
...
export default function MButtonGroup({
  ...
  return (
    <ButtonGroupStyle variant={variant} styleProps={{ color, variant }} theme={theme} {...other}>
      {children}
    </ButtonGroupStyle>
  );
}
